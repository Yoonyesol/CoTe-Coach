                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col bg-white overflow-hidden">
                            ...
                            <div className="flex-1 overflow-y-auto custom-scrollbar">
                                {/* Problem Meta Header */}
                                <div className="px-6 sm:px-12 pt-3 sm:pt-5 pb-1 border-b border-base-100/30 bg-base-50/[0.02]">
                                ...
                                {/* Detail Content Area */}
                                <div className="px-6 sm:px-12 py-2 sm:py-3 space-y-4 sm:space-y-6">
                                    {isEditing ? (
                                        /* EDIT MODE: RECORD */

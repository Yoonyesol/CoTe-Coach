            ...
            {isOpen && (
                <div className="fixed inset-0 z-[1000] flex items-end sm:items-center justify-center p-0 sm:p-4">
                    ...
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="relative w-full max-w-sm bg-white p-8 rounded-[2.5rem] shadow-2xl overflow-y-auto custom-scrollbar font-sans sm:rounded-[2.5rem] rounded-t-[2.5rem] rounded-b-none sm:rounded-b-[2.5rem] mb-0 max-h-[80vh] sm:max-h-none"
                    >
